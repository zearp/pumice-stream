# Pumice Stream
Pumice based on CentOS Stream, blatantly stolen from: [CentOS's alt images sig](https://pagure.io/centos-sig-alt-images/kiwi-descriptions). A customised CentOS Stream install to my liking and for you to use, modify and make into your own.
